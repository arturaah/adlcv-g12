...
def image_to_patches(image, patch_size, image_grid=True):
    ...
    if image_grid:
        ...
        """
        patches = rearrange(image, 'b c (h p1) (w p2) -> b c h p1 w p2',
        ...
        """
        patches = rearrange(patches, 'b c h p1 w p2 -> b (h w) c p1 p2')
    else:
        """
        ...
        """
        #patches = ...
        patches = rearrange(image, 'b c (h p1) (w p2) -> b (h w) (p1 p2 c)', p1=patch_h, p2=patch_w)
