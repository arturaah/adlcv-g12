...
if __name__ == '__main__':
    ...
    model.to(device)
    model.eval()
    model.load_state_dict(torch.load('ex6/weights/classifier/model.pth', map_location=device))
    ...
    plt.savefig('ex6/assets/per_t_accuracy.png', bbox_inches='tight')
    ...
    show_n_forward(vis_images, fig_titles=vis_labels, save_path='ex6/assets/clf_forward.png')
